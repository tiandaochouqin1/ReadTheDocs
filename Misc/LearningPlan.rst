...
.. admonition:: 摘要
   ...
   技术学习路线与资源索引：CS 自学课程推荐（9 门科目含书籍/视频）、Linux 内核学习路径（LKD→ULK→LDD→ULNI→ULVMM）、ARM 学习资料整理和编程实践项目。适合规划自学路线的程序员。
...
2. `网络基本功 <https://www.bookstack.cn/read/network-basic/0.md>`__ ;
   ...
   :download:`网络基本功 </files/LearningPlan/NetworkBasics.pdf>`
...
.. figure:: /images/LearningPlan/emmbed.jpg
   :alt: 嵌入式学习
...
.. figure:: /images/LearningPlan/tk_model.jpg
   :scale: 100%
...
:download:`csapp 英文版 </books/LearningPlan/Computer-Systems-A-Programmers-Perspective-3rd.pdf>` 
...
8. 架构整洁之道。  :download:`Clean Architecture </files/LearningPlan/Clean Architecture_ A Craftsman’s Guide to Software Structure and Design.PDF>`
...
.. figure:: /images/LearningPlan/LinuxPath.jpg
   :alt: 嵌入式学习

Linux编程
------------
1. Unix环境高级编程 :download:`UNIX环境高级编程 第三版 </books/LearningPlan/UNIX环境高级编程 第三版.pdf>`  :download:`apue </books/LearningPlan/APUE-3rd.pdf>`  
2. Linux/UNIX系统编程手册
   :download:`TLPI </books/LearningPlan/The Linux Programming Interface.pdf>` 
   
   :download:`Linux-UNIX系统编程手册（上、下册）.pdf </books/LearningPlan/Linux-UNIX系统编程手册（上、下册）.pdf>` 

   :download:`Linux-UNIX系统编程手册_上册 </books/LearningPlan/Linux-UNIX系统编程手册_上册.pdf>` 
   :download:`Linux-UNIX系统编程手册_下册 </books/LearningPlan/Linux-UNIX系统编程手册_下册.pdf>`

3. :download:`Linux环境编程：从应用到内核 (Linux-Unix技术丛书) </books/LearningPlan/Linux环境编程：从应用到内核 (Linux-Unix技术丛书).pdf>` 
4. Unix网络编程
...
3. :download:`Linux Performance Tools (Velocity 2015) </files/LearningPlan/Velocity2015_LinuxPerfTools.pdf>`
...
.. figure:: /images/LearningPlan/linux_observability_tools.png
