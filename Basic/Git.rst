...
.. admonition:: 摘要
   ...
   Git 全功能速查手册：从工作区/暂存区/仓库三区模型、reset/revert/checkout 的区别、merge/rebase 策略选择到 cherry-pick、submodule、stash 等进阶操作。适合日常开发中快速查阅，也可作为系统学习 Git 的入口。
...
.. figure:: /images/Git/reset_workflow.png
   :scale: 70%
   :alt: workflow
...
.. figure:: /images/Git/git_basic.jpg
   :alt: git_basic

   git_basic

.. .. figure:: /images/Git/Git.jpg
..    :alt: git_basic2
