...
1. Tht first bit: mac地址第一个bit(网络序)指示是否组播，目前大部分组播MAC地址的第1字节都是0x01。
2. The second bit ：0表示全球唯一地址，1表示本地唯一地址。

组播ip和mac的关系
~~~~~~~~~~~~~~~~~~~~~~~

1. ANA规定，IPv4组播MAC地址的高24位为0x01005e，第25位为0，低23位为IPv4组播地址的低23位。
